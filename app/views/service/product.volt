    ...
    <div class="page_baner mt25"><img src="/../../img/index/products_baner.jpg" alt="关于万邦产品与服务"></div>
 	...
 	<section class="about_aside">
		...
		<ul class="aside_listbox">
			<li><a href="/service/index" class="aside_btn_on clearfix"><span style="margin-left: 0px;" class="fl">万邦产品</span><i class="web_skin aside_arrow"></i></a></li>
