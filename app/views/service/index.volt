 ...
 <!--
   <div class="about_conter fr mt30">
    <section class=" rel">
     ...
     <p class="mbx">当前位置：首页  &gt; 公司服务 &gt; 公司产品</p>
     <div class="hycp_box mt10">
     	<ul class="cp_tbbg cp_tab001  clearfix" style="border-bottom:none;">
            ...
            <li class="medio_tab" onclick="javascript:changeType(2)">全部产品</li>
        </ul>
                ...
                {% endfor %}             
               	<li>
                    ...
                    <dl class="clearfix">
                    	<dt class="sy fl bg02">
                        	<span>预期收益</span>
                            <span class="sy_number">10.2%</span>
                        </dt>
                        <dd class="jianjie fr">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</dd>
                    </dl>
                    <p class="in_btnbox"><a href="http://www.chyjr.com/site/web/productDetail.shtml?pid=87" target="_blank">进入详情</a></p>
                </li>
              	...
              	<li>
                    ...
                    <dl class="clearfix">
                    	<dt class="sy fl bg03">
                        	<span>预期收益</span>
                            <span class="sy_number">10.6%</span>
                        </dt>
                        <dd class="jianjie fr">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</dd>
                    </dl>
                    <p class="in_btnbox"><a href="http://www.chyjr.com/site/web/productDetail.shtml?pid=85" target="_blank">进入详情</a></p>
                </li>
                
              	<li>
                	<h2><span>产品名称：</span>XXXXXXXXXX</h2>
                    <h2><span>产品类型：</span>XXXXXXXXXXXXXXXXXXXX</h2>
                    
                    <dl class="clearfix">
                    	<dt class="sy fl bg04">
                        	<span>预期收益</span>
                            <span class="sy_number">10.5%</span>
                        </dt>
