...
<section>
    ...
    <section class="rel">
     <h2 class="title_text ">服务理念</h2>
      <p class="mbx">当前位置：<a href="#">首页</a>  &gt; <a href="#">产品与服务</a> &gt; 服务理念</p>
     <div class="hycp_box mt10">
      <section class=" clearfix cpsxbox mt30">
         <div class="fl cpsx_img">
     		 <h2>严格的产品筛选和风控体系：</h2>
        </div>
         <div class="fr js_zcbox">
             <h2>强大的信息技术支持：</h2>
             <dl>
                <dt><i class="web_skin jszc_icon01"></i></dt>
                <dd>
                    <h3>金融安全保护</h3>
                    <p>客户资料安全性保护，<br>全方位保卫客户资产安全</p>
                </dd>
             </dl>
             <dl>
                <dt><i class="web_skin jszc_icon02"></i></dt>
                <dd>
                    <h3>金融信息库</h3>
                    <p>产品信息，行业动态，研究<br>报告一网打尽，尽享一站式服务</p>
                </dd>
             </dl>
             <dl>
                <dt><i class="web_skin jszc_icon03"></i></dt>
                <dd>
                    <h3>智能分析</h3>
                    <p>智能客户动态评估及多维度分析报告，<br>科学的定量和定性分析，使量化的资<br>产配置更清晰</p>
                </dd>
             </dl>
         </div>
      </section>
