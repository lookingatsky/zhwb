			...
			<div class="laybox_video hide rel">
				...
				<div class="video_jianjie">
					<article>
						...
						<p>对于风险控制管理，中合万邦从源头上对产品风险进行把控，深入调查、跟踪产品运作情况，确保产品的安全性及其市场稀缺性。同时我们有着完善的产品存续期的管理服务，持续改进产品研发设计与甄选能力，力求提供完美的客户服务品质。除此之外，中合万邦内部有着紧密相连的几大运营体系，如动态的财富管理体系，卓越的信息服务体系，安全稳健的客户管理系统，使我们的客户享有专属、私密的财富管理体验。 </p>
					</article>
				</div>
			</div>
