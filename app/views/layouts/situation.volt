        ...
        <div class="menubox fr">
          ...
          <nav>
            <ul class="clearfix menu_list mt20"> <li class="w77"><a href="/index/index">首&nbsp;&nbsp;页</a></li>
              ...
              <li class="rel">
               <a style="" href="/about/index">关于万邦</a><!-- class="menu_on" -->
               <div class="menulist">
               		<ul class="clearfix ulbox">
                        ...
                        <li><a style="" href="/about/culture">万邦文化<i class="web_skin menu_icon"></i> </a></li>
              ...
              <li class="menu_line">|</li>
              <li class="rel">
              <a href="/situation/index" class="menu_on">万邦动态</a>
              <div class="menulist">
              ...
              <div class="menulist">
               		<ul class="clearfix ulbox">
                    	<li><a style="" href="/service/index">万邦产品<i class="web_skin menu_icon"></i></a></li>
    ...
    <footer>
      <div class="footer_conter clearfix">
      	<div class="fl footer_leftbox">
			...
			<a href="http://www.cnzz.com/stat/website.php?web_id=4126230" target="_blank" title="站长统计"><img src="/../../img/index/pic.gif" hspace="0" border="0" vspace="0"></a>
			</span></span>
			</p>
        </div>
